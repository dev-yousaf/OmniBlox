...
describe('Stock E2E on live DB', () => {
  ...
  const productsTable = async (
    ...
    return { id: p?.id as string, stock: (p as any)?.stock ?? -1 };
  };
    ...
    const dup = productService.create(
      {
        ...
        warehouseId: wh1,
        stock: 0,
        variants: [{ sku: v0.sku, name: 'Dup Variant', salePrice: 1, costPrice: 1, stock: 0, reorderLevel: 0, taxRate: 0 }],
      },
      companyId,
      userId,
    );
    ...
    const dupInternal = productService.create(
      {
        ...
        stock: 0,
        variants: [
          { sku: `E2E-X-${Date.now()}`, name: 'X1', salePrice: 1, costPrice: 1, stock: 0, reorderLevel: 0, taxRate: 0 },
          { sku: `E2E-X-${Date.now()}`, name: 'X2', salePrice: 1, costPrice: 1, stock: 0, reorderLevel: 0, taxRate: 0 },
        ],
      },
      companyId,
      userId,
    ...
    const parent = await productService.create(
      {
        ...
        hasVariants: true,
        variants: [
          { sku: `E2E-VE1-${Date.now()}`, name: 'Edit Var 1', salePrice: 20, costPrice: 10, stock: 10, reorderLevel: 0, taxRate: 0 },
          { sku: `E2E-VE2-${Date.now()}`, name: 'Edit Var 2', salePrice: 20, costPrice: 10, stock: 10, reorderLevel: 0, taxRate: 0 },
          { sku: `E2E-VE3-${Date.now()}`, name: 'Edit Var 3', salePrice: 20, costPrice: 10, stock: 10, reorderLevel: 0, taxRate: 0 },
        ],
      },
      companyId,
      userId,
    ...
    const parent = await productService.create(
      {
        ...
        hasVariants: true,
        variants: [
          { sku: `E2E-VS1-${Date.now()}`, name: 'Sale Var 1', salePrice: 15, costPrice: 7, stock: 10, reorderLevel: 0, taxRate: 0 },
          { sku: `E2E-VS2-${Date.now()}`, name: 'Sale Var 2', salePrice: 15, costPrice: 7, stock: 10, reorderLevel: 0, taxRate: 0 },
          { sku: `E2E-VS3-${Date.now()}`, name: 'Sale Var 3', salePrice: 15, costPrice: 7, stock: 10, reorderLevel: 0, taxRate: 0 },
        ],
      },
      companyId,
      userId,
    ...
    const parent = await productService.create(
      {
        ...
        hasVariants: true,
        variants: [
          { sku: `E2E-CV1-${Date.now()}`, name: 'Cart Var 1', salePrice: 8, costPrice: 4, stock: 8, reorderLevel: 0, taxRate: 0 },
        ],
      },
      companyId,
      userId,
