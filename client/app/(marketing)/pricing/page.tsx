...
const faqs = [
  { q: "Can I upgrade or downgrade my plan anytime?", a: "Yes. You can change your plan at any time. When upgrading, you'll be charged the prorated difference. When downgrading, the new rate applies at the next billing cycle." },
  { q: "Is there a free trial?", a: "Yes! All plans come with a 14-day free trial. No credit card required. You can explore all features during your trial." },
  ...
  { q: "Can I cancel my subscription?", a: "Absolutely. You can cancel anytime from your settings. Your data remains accessible until the end of your billing period." },
  { q: "Do you offer discounts for annual billing?", a: "Yes. Annual plans are billed at 2 months free — you pay for 10 months and get 12 months of service." },
  { q: "Is my data secure?", a: "Absolutely. We use end-to-end encryption, regular security audits, and SOC2-grade practices. Your data is backed up daily." },
];
        ...
        <div className="relative mx-auto max-w-4xl px-6">
          <FadeIn>
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
              Simple, Transparent{" "}
              <span className="bg-gradient-to-r from-primary to-chart-4 bg-clip-text text-transparent">Pricing</span>
            </h1>
          </FadeIn>
          <FadeIn delay={0.1}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {plans.map((plan, i) => (
              <FadeIn key={plan.name} delay={i * 0.1}>
                <div className={`relative rounded-2xl border bg-card p-8 flex flex-col ${plan.popular ? "border-primary shadow-lg shadow-primary/10 scale-[1.02]" : ""}`}>
                  {plan.popular && (
              ...
              <FadeIn key={faq.q} delay={i * 0.05}>
                <details className="group rounded-xl border bg-card p-6 [&_summary::-webkit-details-marker]:hidden">
                  <summary className="flex items-center justify-between cursor-pointer">
                    ...
                    <svg className="h-4 w-4 shrink-0 transition-transform group-open:rotate-180" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M6 9l6 6 6-6" /></svg>
                  </summary>
