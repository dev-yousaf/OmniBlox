...
const features = [
  { icon: Package, title: "Inventory Management", desc: "Real-time stock tracking, barcode scanning, and automated reorder alerts to keep your business running." },
  { icon: ShoppingCart, title: "Sales & Invoicing", desc: "Create quotes, invoices, and process payments with a few clicks. Track every transaction from start to finish." },
  { icon: BarChart3, title: "Advanced Analytics", desc: "Beautiful dashboards with real-time insights into sales, profits, inventory turnover, and business trends." },
  { icon: Users, title: "Team Management", desc: "Role-based access control with granular permissions. Manage your team with OWNER, ADMIN, MANAGER, and STAFF roles." },
  { icon: Warehouse, title: "Multi-Warehouse", desc: "Manage multiple warehouses and transfer stock between locations with full tracking and audit history." },
  { icon: Shield, title: "Enterprise Security", desc: "Audit logging, OTP verification, magic link login, and SOC2-grade encryption to protect your data." },
];
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center">
          ...
          <FadeIn delay={0.2}>
            <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Inventory, sales, purchases, team management, and analytics — all in one powerful platform. Stop juggling spreadsheets and start growing.
            </p>
          </FadeIn>
          <FadeIn delay={0.3}>
            ...
            <FadeIn direction="right">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: Globe, title: "Cloud Native", desc: "Access from anywhere" },
                  { icon: Shield, title: "Bank-Grade Security", desc: "Your data is safe" },
                  { icon: TrendingUp, title: "Always Improving", desc: "Weekly updates" },
                ].map((item) => (
                  <div key={item.title} className="rounded-xl border bg-card p-6 text-center hover:border-primary/20 transition-colors">
              ...
              <FadeIn key={t.name} delay={i * 0.15}>
                <div className="rounded-2xl border bg-card p-8 h-full flex flex-col">
                  <div className="flex gap-1 mb-4">
                    {[...Array(5)].map((_, j) => (
                      <svg key={j} className="h-4 w-4 fill-primary" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                    ))}
                  </div>
                  <p className="text-muted-foreground flex-1">&ldquo;{t.quote}&rdquo;</p>
